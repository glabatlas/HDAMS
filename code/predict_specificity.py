...
if __name__ == "__main__":
    ...
    print('the one-hot coding features:\t%d'% len(one_hot_code))
    ...
    print ('the chemical coding features:\t%d'% len(chemical_code))
    ...
    for seq_id in dic_seq:
        ...
        dic_comb.setdefault(seq_id, ifeature)
    print ('the nuclein coding features:\t%d'% len(nucle_code))
    ...
    for seq_id in dic_seq:
        ...
        dic_comb.setdefault(seq_id, ifeature)
    print ('the clarity coding features:\t%d'% len(purity_code))
    ...
    for seq_id in dic_seq:
        ...
        dic_comb.setdefault(seq_id, ifeature)
    print ('the energy coding features:\t%d'% len(energy_code))
    ...
    print('the final combined coding features:\t%d'% len(ls_value))
    fout_seq_6.close()
    ...
    feature_id_input = open('./training_data/selected_feature_index-org.txt', 'r')
    ...
    ##  model with: svm-lr
    ##################################################################
    model_name_1 = ['svm-org.joblib', 'lr-org.joblib']
    ...
    fout_predict_data_1.writelines('seq_id\tprob_beta_low\tprob_beta_medium\tprob_beta_high\n')
    for i in range(SN_1):
